...
<head>
    ...
    <title>Welcome to Camping Grounds!</title>
                ...
                <div class="header-right">
                    ...
                    <div id="popup" class="popup">
                        <div class="popup-content">
                            ...
                            <form id="addItemForm" method="post" action="camping_grounds_upload.php" enctype="multipart/form-data">
            ...
            <div class="function-container">
                ...
                <div class="photoContainer">
                    ...
                    <div class="item">
                        ...
                        $placeName = 'Yahangala';
                        $selectQuery = "SELECT photo_data, province, place_name FROM camping_grounds WHERE place_name = ?";
                    ...
                    <div class="item">
                        ...
                        // Retrieve images, province, and place name for a specific place name (replace 'your_place_name' with the actual place name)
                        $placeName = 'Kalugala Gerandi Ella Waterfall';
                        $selectQuery = "SELECT photo_data, province, place_name FROM camping_grounds WHERE place_name = ?";
                        $stmt = $mysqli->prepare($selectQuery);
                        $stmt->bind_param("s", $placeName);
                        $stmt->execute();
                    ...
                    <div class="item">
                        ...
                        // Retrieve images, province, and place name for a specific place name (replace 'your_place_name' with the actual place name)
                        $placeName = 'Great Western Mountain';
                        $selectQuery = "SELECT photo_data, province, place_name FROM camping_grounds WHERE place_name = ?";
                        $stmt = $mysqli->prepare($selectQuery);
                        $stmt->bind_param("s", $placeName);
                        $stmt->execute();
