...
function changeInfo(direction) {
	...
	gsap.timeline()
		...
		.fromTo(
		direction === "right"
		? card2InfoEl.querySelectorAll(".text")
		: card3InfoEl.querySelectorAll(".text"),
		{
			opacity: 0,
			translateY: "40px",
		},
...
function init() {
	...
	tl.to(cardsContainerEl.children, {
		...
		.to(cardInfosContainerEl.querySelector(".card1info").querySelectorAll(".text"), {
		delay: 0.5,
		duration: 0.4,
		stagger: 0.1,
		opacity: 1,
...
const waitForImages = () => {
	...
	gsap.set(cardInfosContainerEl.querySelector(".card1info").querySelectorAll(".text"), {
		translateY: "40px",
		opacity: 0,
	});
